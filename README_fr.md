...
[![Platform](https://img.shields.io/badge/Plateforme-macOS%20%7C%20iPadOS-blue?logo=apple)](https://developer.apple.com)
...
- **macOS** avec Xcode 16+ — ouvrir `Echo-Imprint.swiftpm` directement dans Xcode
- **iPadOS** avec Swift Playgrounds 4+ — ouvrir le paquet `.swiftpm` sur iPad
...
> 💡 Accès refusé par erreur ? Sur Mac : **Réglages système → Confidentialité et sécurité → Microphone**. Sur iPad : **Réglages → Confidentialité et sécurité → Microphone**.
...
> 💡 Sur Mac : **Réglages système → Accessibilité → VoiceOver**. Sur iPad : **Réglages → Accessibilité → VoiceOver**, ou triple-cliquez sur le bouton latéral.
